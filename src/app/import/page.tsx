    ...
    <div>
          ...
          <div className="bg-white border border-stone-200 shadow-sm rounded-sm p-6">
            ...
            {scanning ? (
              ...
              <button
                ...
                className="w-full bg-teal-600 hover:bg-teal-700 text-white py-2.5 rounded text-[11px] tracking-[0.2em] uppercase transition-colors"
              >
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-teal-600 hover:bg-teal-700 text-white py-3 rounded text-[11px] tracking-[0.2em] uppercase transition-colors shadow-sm"
            >
      ...
      {step === 'done' && result && (
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <a href="/stok" className="flex-1 bg-teal-600 hover:bg-teal-700 text-white py-3 rounded text-[11px] tracking-[0.2em] uppercase transition-colors text-center shadow-sm">
              Stok Sayfasına Git
            </a>
            <button
