...
export default function TakaslarPage() {
  ...
  const [tab, setTab] = useState<'takas' | 'gecmis'>('takas')
  ...
  function addToCart(product: Product) {
    setCart(prev => {
      ...
      return [...prev, { product, quantity: 1, unit_price: product.standard_price }]
    })
    setSearch('')
  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 88px)' }}>
      ...
      <div className="flex items-end gap-0 mb-5 border-b border-stone-200 flex-shrink-0">
        {[
          { key: 'takas', label: 'Yeni Takas' },
          { key: 'gecmis', label: 'Takas & Borç Geçmişi' },
        ].map(t => (
          <button
            key={t.key}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="p-2.5 flex flex-col gap-1.5 flex-1">
                          ...
                          {inCart && (
                            <div className="bg-teal-600 text-white text-center text-[10px] font-semibold py-0.5 rounded-sm tracking-wide">
                ...
                {cart.length > 0 && (
                  <div className="border-t border-stone-100 px-4 py-4 space-y-3 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="w-full bg-teal-600 hover:bg-teal-700 text-white py-4 rounded-sm text-[11px] tracking-[0.3em] uppercase font-semibold transition-all"
                    >
                      Alıcı Mağazayı Seç →
                    </button>
                  </div>
